...
from iou_tracker_old_version import IOUTracker # Import our new tracker
...
def yolo_sahi_pose_tracking(source=0, size=(1440, 810), sahi_conf_threshold=0.4, sahi_iou_threshold=0.7, pose_conf_threshold=0.5, pose_iou_threshold=0.7, tracker_iou_threshold=0.5):
    ...
    video_writer = cv.VideoWriter("yolo-sahi-pose-tracking.mp4", cv.VideoWriter_fourcc(*"mp4v"), original_fps, (size[0], size[1]))
